  ...
  return (
    <div>
      ...
      <div className="w-full border-b-2 border-gray-100 flex gap-x-6 my-5">
        <div className={`cursor-pointer ${tab === 1 && 'subs_active'}`} onClick={() => setTab(1)}>
          Previous
        </div>
        <div className={`cursor-pointer ${tab === 2 && 'subs_active'}`} onClick={() => setTab(2)}>
          Current
        </div>
      </div>
              ...
              <div className="rounded-lg border bg-white text-center" key={key}>
                ...
                <div className="px-3 pb-3">
                  ...
                  <Button
                    ...
                    size="large"
                    shape="round"
                    className="bg-green w-full mt-2"
                  >
                    Choose May 24 to May 31
                  </Button>
                </div>
              </div>
            ))}
          ...
          <>
            <div className="rounded-lg border bg-white text-center">
              ...
              <div className="px-3 pb-3">
                ...
                <Button type="primary" size="large" shape="round" className="bg-green w-full mt-2">
                  Choose May 24 to May 31
                </Button>
              </div>
            </div>
