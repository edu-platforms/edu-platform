  ...
  return (
    <div className="flex flex-col items-center w-2/4 px-12 py-10">
      ...
      <h2 className="text-center my-10 font-medium">
        Your information has been sent! We check your information. This may take several hours. We
        will be answered you soon! Thank you for being with us
      </h2>
      <Button
        onClick={onFinish}
        className="bg-green h-14 w-2/4 flex items-center justify-center"
        type="primary"
      >
